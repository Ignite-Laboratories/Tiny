...
func Select[T any](expr Expression, operands ...T) ([]T, error) {
...
func Emit[T Operable](expr Expression, operands ...T) ([]Bit, error) {
	...
	if totalWidth == 0 {
		return make([]Bit, 0), ErrorNothingToEmit
	}
...
func evaluateExpression[T any](expr Expression, totalWidth uint, operands ...T) (Expression, []T) {
